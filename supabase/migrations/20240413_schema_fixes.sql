-- Drop duplicate tables and recreate with consolidated schema
DROP TABLE IF EXISTS product_news_items;
DROP TABLE IF EXISTS price_history;
DROP TABLE IF EXISTS news_items;
DROP TABLE IF EXISTS products;
DROP TABLE IF EXISTS categories;
DROP TABLE IF EXISTS users;
DROP TABLE IF EXISTS user_product_alerts;
...
CREATE INDEX idx_news_items_countries ON news_items USING GIN (countries);
